...
class CryptoData {
  ...
  CryptoData.fromJson(dynamic json) {
    ...
    _totalSupply = json['totalSupply'].toDouble();
    ...
    _ath = json['ath'].toDouble();
    _atl = json['atl'].toDouble();
    _high24h = json['high24h'].toDouble();
    _low24h = json['low24h'].toDouble();
...
class Quotes {
  ...
  Quotes.fromJson(dynamic json) {
    ...
    _volume24h = json['volume24h'].toDouble();
    _volume7d = json['volume7d'].toDouble();
    _volume30d = json['volume30d'].toDouble();
    _marketCap = json['marketCap'].toDouble();
    _selfReportedMarketCap = json['selfReportedMarketCap'].toDouble();
    _percentChange1h = json['percentChange1h'].toDouble();
    _percentChange24h = json['percentChange24h'].toDouble();
    _percentChange7d = json['percentChange7d'].toDouble();
    _lastUpdated = json['lastUpdated'];
    _percentChange30d = json['percentChange30d'].toDouble();
    _percentChange60d = json['percentChange60d'].toDouble();
    _percentChange90d = json['percentChange90d'].toDouble();
